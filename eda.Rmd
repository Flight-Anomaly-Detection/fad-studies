...
This report describes the inital findings of the exploratory data analysis conducted for building the foundation of the anomaly detection algorithm to be developed. Is is divided in the following sections:
...
* **Landing drill down**: discussion focused on the landing fase;
...
Discuss clustering methodolgy and results. Improve visualization without color repetition.
